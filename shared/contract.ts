...
export interface AdminOverviewResponse {
  ...
  syntheticContractors: number;
  cityImputedContractors: number;
  priceImputedContractors: number;
  missingMaxHoursContractors: number;
  priceFromKzt: {
    min: number | null;
    max: number | null;
    average: number | null;
...
export type AdminContractorStatus = 'all' | 'active' | 'inactive';

export interface AdminContractorsQuery {
  search?: string;
  city?: string;
  category?: string;
...
export interface UpdateContractorStatusRequest {
  isActive: boolean;
}

export interface UpdateContractorStatusResponse {
