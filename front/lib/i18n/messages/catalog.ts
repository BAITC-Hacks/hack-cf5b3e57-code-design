...
export const catalogMessages = {
  ru: {
    ...
    catalog: {
      ...
      searchGeographies: "географии поиска",
    ...
    detail: {
      ...
      sourceNote:
        "Описание — со слов подрядчика. Фильтры по цене, городу, формату, языку и времени проверяются по структурированным данным.",
      ...
      formats: "Форматы",
      languages: "Языки",
      dataEyebrow: "Происхождение данных",
      important: "Что важно знать",
      syntheticTitle: "Синтетический профиль",
      syntheticText:
        "Профиль создан для покрытия редкого сценария и явно отмечен в данных.",
      cityImputedTitle: "Город проставлен",
      cityImputedText: "Город восстановлен при подготовке набора данных.",
      priceImputedTitle: "Цена проставлена",
      priceImputedText:
        "Стартовая цена восстановлена при подготовке набора данных.",
      cleanDataTitle: "Без восстановленных полей",
  ...
  kk: {
    ...
    catalog: {
      heroEyebrow: "Қазақстандағы іс-шара мердігерлерінің каталогы",
      heroTitleFirst: "Өз адамдарыңызды табыңыз.",
      heroTitleSecond: "Таңдауды деректерге сеніп тапсырыңыз.",
      heroLead:
        "Толық каталогты өзіңіз зерттеңіз немесе іс-шараны сипаттаңыз — AI қала, күн, формат пен бюджетті тексеріп, әр нұсқаны түсіндіреді.",
      chooseWithAi: "AI арқылы таңдау",
      ...
      searchGeographies: "іздеу географиясы",
    ...
    detail: {
      ...
      sourceNote:
        "Сипаттама — мердігердің өз сөзінен. Баға, қала, формат, тіл және уақыт сүзгілері құрылымдалған деректермен тексеріледі.",
      ...
      formats: "Форматтар",
      languages: "Тілдер",
      dataEyebrow: "Деректердің шығу тегі",
      important: "Маңызды ақпарат",
      syntheticTitle: "Синтетикалық профиль",
      syntheticText:
        "Профиль сирек сценарийді жабу үшін жасалған және деректерде анық белгіленген.",
      cityImputedTitle: "Қала толықтырылған",
      cityImputedText: "Қала деректер жинағын дайындау кезінде қалпына келтірілген.",
      priceImputedTitle: "Баға толықтырылған",
      priceImputedText:
        "Бастапқы баға деректер жинағын дайындау кезінде қалпына келтірілген.",
      cleanDataTitle: "Қалпына келтірілген өрістер жоқ",
  ...
  en: {
    ...
    catalog: {
      heroEyebrow: "Kazakhstan event contractor catalog",
      heroTitleFirst: "Find your team.",
      heroTitleSecond: "Trust the facts.",
      heroLead:
        "Explore the full catalog yourself or describe your event — AI will check the city, date, format, and budget, then explain every option.",
      chooseWithAi: "Match with AI",
      ...
      searchGeographies: "search regions",
    ...
    detail: {
      ...
      sourceNote:
        "The description is provided by the contractor. Price, city, format, language, and duration filters are verified against structured data.",
      ...
      formats: "Formats",
      languages: "Languages",
      dataEyebrow: "Data provenance",
      important: "What to know",
      syntheticTitle: "Synthetic profile",
      syntheticText:
        "This profile was created to cover a rare scenario and is explicitly marked in the data.",
      cityImputedTitle: "City inferred",
      cityImputedText: "The city was restored while preparing the dataset.",
      priceImputedTitle: "Price inferred",
      priceImputedText:
        "The starting price was restored while preparing the dataset.",
      cleanDataTitle: "No inferred fields",
      cleanDataText: "The city and price come from the source profile.",
    },
    errors: {
