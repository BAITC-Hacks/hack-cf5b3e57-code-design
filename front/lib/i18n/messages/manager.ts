...
export type ManagerMessages = {
  ...
  pipeline: {
    ...
    interrupted: string; retry: string; aria: string; step: string;
...
const ru: ManagerMessages = {
  ...
  pipeline: {
    section: "02", title: "Поток решений", live: "SSE live", emptyTitle: "Пайплайн ждёт запрос", emptyDescription: "Выберите один из четырёх сценариев — здесь появятся реальные этапы обработки без скрытого спиннера.",
